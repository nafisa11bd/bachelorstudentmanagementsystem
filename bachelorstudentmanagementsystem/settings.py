"""
Django settings for bachelorstudentmanagementsystem project.
...
SECRET_KEY = 's@vxdd^t4xi12z%!u_^zgshs3c-42@^(qrgh&wtanjuo=7y7u_'
...
ROOT_URLCONF = 'bachelorstudentmanagementsystem.urls'
...
WSGI_APPLICATION = 'bachelorstudentmanagementsystem.wsgi.application'
